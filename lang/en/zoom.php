...
$string['setting_breakoutroom'] = 'Allow pre-assigned breakout rooms';
$string['setting_breakoutroom_help'] = 'Enabling this option will allow the creation of breakout rooms that can be pre-assigned.';
